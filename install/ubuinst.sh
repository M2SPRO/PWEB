...
exit;
  ...
  echo -e 'by: @M2SPRO' >/usr/lib/telegram
  msg -bar
...
wget https://github.com/M2SPRO/PWEB/raw/main/install/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://github.com/M2SPRO/PWEB/raw/main/install/verifatt.sh > /dev/null 2>&1
wget https://github.com/M2SPRO/PWEB/raw/main/install/verpweb > /dev/null 2>&1
wget https://github.com/M2SPRO/PWEB/raw/main/install/verweb > /dev/null 2>&1
wget https://github.com/M2SPRO/PWEB/raw/main/install/whatsapp.sh > /dev/null 2>&1
...
wget https://github.com/M2SPRO/PWEB/raw/main/install/gestorssh.zip > /dev/null 2>&1
...
echo -e "                              \033[1;31mBy @M2SPRO\033[1;36m" | lolcat
echo ""
chave=$(curl -sSL "https://github.com/M2SPRO/PWEB/raw/main/install/chave") &>/dev/null
...
echo ""
echo -e "PAINEL M2SPRO WEB" | figlet | boxes -d stone -p a0v0 | lolcat
echo -e "                              \033[1;31mBy @MESPRO\033[1;36m" | lolcat
echo ""
